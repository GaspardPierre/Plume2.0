...
CREATE TABLE "WorkLabel" (
    ...
    CONSTRAINT "WorkLabel_pkey" PRIMARY KEY ("workId","labelId")
);
...
-- AddForeignKey
ALTER TABLE "WorkLabel" ADD CONSTRAINT "WorkLabel_workId_fkey" FOREIGN KEY ("workId") REFERENCES "Work"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "WorkLabel" ADD CONSTRAINT "WorkLabel_labelId_fkey" FOREIGN KEY ("labelId") REFERENCES "Label"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
